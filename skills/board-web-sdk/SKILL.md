...
- Use the harness and generated game build helpers instead of invoking Gradle directly; they detect common local JDK and Android SDK settings before running Gradle.
