package co.harrishill.board.websdktest;
...
public class BoardWebViewActivity extends Activity {
    private static final String TAG = "BoardWebTest";
    private static final String TEST_APP_ID = "00000000-0000-0000-0000-web-sdk-test";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BoardNativePlugin.setAppId(TEST_APP_ID);
